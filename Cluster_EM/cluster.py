...
from  Cluster_EM.agglomerative_clustering import test_AgglomerativeClustering, test_AgglomerativeClustering_nclusters, \
    test_AgglomerativeClustering_linkage
from Cluster_EM.dbscan import test_DBSCAN, test_DBSCAN_epsilon, test_DBSCAN_min_samples
from Cluster_EM.gmm import test_GMM, test_GMM_cov_type, test_GMM_n_components
from Cluster_EM.kmeans import test_Kmeans, test_Kmeans_n_init, test_Kmeans_nclusters
...
def create_data(centers, num=100, std=0.7):
    ...
    '''
    X, labels_true = make_blobs(n_samples=num, centers=centers, cluster_std=std)    #生产分隔的高斯分布的聚类簇
